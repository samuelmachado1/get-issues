            ...
            <tbody>
              {
                issues.map((issue) => (
                  ...
                  <tr>
                    {issue.number % 2 != 0 ?<TableCell component="th" scope="row" style={{ width: 160 }} align="center">
                      {issue.number}
                    </TableCell> :<TableCell component="th" scope="row" style={{ width: 160}} align="center" color="secondary">
                      {issue.number}
                    </TableCell>}
