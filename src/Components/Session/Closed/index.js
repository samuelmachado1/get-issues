        ...
        <Table>
          <thead>
            <tr>
              ...
              <th><FormatedLabel>Fechada em:</FormatedLabel></th>
                  ...
                  <tr>
                    {   issue.number % 2 != 0 ?
                      <>
                          ...
                          <TableCell component="th" scope="row" style={{ width: 160 }} align="center">
                             <FormatedTitle>{issue.closed_at.replace(/(\d*)-(\d*)-(\d*).*/, '$3/$2/$1')}</FormatedTitle>
                          </TableCell>
                          <TableCell component="th" scope="row" style={{ width: 160 }} align="center">
                      ...
                      <>
                        ...
                        <TableCell component="th" scope="row" style={{ width: 160 }} align="center">
                          <FormatedLabel>{issue.closed_at.replace(/(\d*)-(\d*)-(\d*).*/, '$3/$2/$1')}</FormatedLabel>
                        </TableCell>
